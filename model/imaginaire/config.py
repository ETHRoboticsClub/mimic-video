...
class CheckpointConfig:
    ...
    # Whether to also save checkpoints at epoch boundaries near 10k iteration boundaries.
    save_at_epoch_end: bool = True
    # Keep only the latest N local checkpoints. None keeps all checkpoints.
...
class TrainerConfig:
    ...
    # Whether to also validate after each completed training dataloader epoch.
