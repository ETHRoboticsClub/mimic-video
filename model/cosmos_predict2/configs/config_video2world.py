...
class Video2WorldPipelineConfig:
    ...
    state_ch: int = 16
    state_t: int = 24
    # FPS token injected when constructing the conditioner from a data_batch
    # that doesn't carry one (IDM path: MimicDataset has no fps field). For
    # Cosmos Predict2 video2world, constants.py asserts fps == 10.
    fps: int = 10
