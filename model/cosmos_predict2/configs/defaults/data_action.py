...
def get_data_config(
    ...
    val_episode_ranges: list[dict] | None = None,
    ...
    if data_dir_override is not None:
        cfg.dataset.dataset.data_dir = data_dir_override
    if num_val_episodes is not None:
        cfg.dataset.dataset.num_val_episodes = num_val_episodes
    if val_episode_ranges is not None:
        cfg.dataset.dataset.val_episode_ranges = val_episode_ranges
    if val_ratio is not None:
        cfg.dataset.dataset.val_ratio = val_ratio
...
DATA_CONFIGS = {
    f.stem: L(get_data_config)(config_name=f.stem, data_dir_override=None)
