...
from cosmos_predict2.callbacks.save_dataset_stats import SaveDatasetStats
...
BASIC_CALLBACKS = dict(
    wandb=L(WandBCallback)(enabled=False),
    ...
    save_dataset_stats=L(SaveDatasetStats)(config=PLACEHOLDER, trainer=PLACEHOLDER),
)
