...
uv run ./data_preprocessing/action/process_lerobot.py
    --dataset-dir <path_to_lerobot_v3_dataset> \
...
```bash
uv run ./data_preprocessing/action/process_lerobot.py \
  --dataset-dir ~/.cache/huggingface/hub/datasets--ETHRC--robot-learning-fs26/snapshots/a49199473f399e962f26777c2ef89d9e19f1a20e \
  --output-dir ~/zarr \
  --num-workers 24
```
